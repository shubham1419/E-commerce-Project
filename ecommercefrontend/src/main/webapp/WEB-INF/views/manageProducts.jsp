			...
			<div class="panel-body">
				<sf:form class="form-horizontal" modelAttribute="product" action="${contextRoot}/manage/products" method = "POST">
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<sf:textarea path="description" id="description" placeholder="Product Description" class="form-control"></sf:textarea>
						</div>
					</div>
					...
					<div class="form-group">
						<label class="control-label col-md-4" for="price">Enter
							Product Price: </label>
						<div class="col-md-8">
							<sf:input type="text" path="unitPrice" id="unitPrice" placeholder="Product Price" class="form-control" />
						</div>
					</div>

					<div class="form-group">
						<label class="control-label col-md-4" for="brand">Qty Available: </label>
						<div class="col-md-8">
					...
					<div class="form-group">
						<label class="control-label col-md-4" for="catedoryId">Select Category: </label>
						<div class="col-md-8">
